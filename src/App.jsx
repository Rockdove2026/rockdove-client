...
const styles = {
  ...
  topCardName: { fontFamily:"'Hanken Grotesk','Josefin Sans',sans-serif", fontSize:13, fontWeight:700, color:DARK, margin:"0 0 8px", lineHeight:1.35, letterSpacing:"0.3px", textTransform:"uppercase" },
  topCardPos: { fontFamily:"'Hanken Grotesk',sans-serif", fontSize:10, fontWeight:400, color:"#AAA", margin:"0 0 8px", lineHeight:1.5 },
  topCardPrice: { fontSize:13, fontWeight:600, color:DARK, margin:0, fontFamily:"'Hanken Grotesk',sans-serif", letterSpacing:"0.3px" },
  ...
  tierBadge: { fontSize:9, fontWeight:600, letterSpacing:"2px", textTransform:"uppercase", display:"inline-block", padding:"2px 0", marginBottom:8, fontFamily:"'Hanken Grotesk',sans-serif", background:"none", border:"none" },
  tierGold: { color:"#9A7B35" },
  tierPlat: { color:"#5A7AAA" },
  tierSilv: { color:"#AAA" },
  cardName: { fontFamily:"'Hanken Grotesk','Josefin Sans',sans-serif", fontSize:12, fontWeight:700, color:DARK, margin:"0 0 6px", lineHeight:1.35, letterSpacing:"0.3px", textTransform:"uppercase" },
  cardPrice: { fontSize:12, fontWeight:600, color:DARK, margin:0, fontFamily:"'Hanken Grotesk',sans-serif", letterSpacing:"0.3px" },
